#!/usr/bin/env python3
"""
Convert API_CONTRACTS.md to PDF.

Usage:
  1. Install: pip install markdown xhtml2pdf
  2. Run: python scripts/md_to_pdf_api_contracts.py

Output: API_CONTRACTS.pdf (in data-pipeline-service folder)
"""
import os
...
MD_PATH = os.path.join(PROJECT_ROOT, "API_CONTRACTS.md")
PDF_PATH = os.path.join(PROJECT_ROOT, "API_CONTRACTS.pdf")
...
<head>
<meta charset="UTF-8">
<title>Data Pipeline Service - API Contracts</title>
{CSS}
</head>
<body>
{html_body}
